 ...
 *
 * YANA n'expose qu'un seul client service_role (createServiceClient, src/lib/supabase.ts)
 * — utilisé à la fois pour .auth.admin.* et pour les requêtes de table, contrairement à
 * arogya qui en sépare deux (cf packages/legal/README.md « Adaptations réellement
 * nécessaires par app »).
 */
