...
6. Design CLAUDE-2.md (sections 9/9bis/9ter)
...
> « Lis le BRIEF.md, CLAUDE.md et KARMA_INTEGRATION.md. Lis aussi CLAUDE-2.md sections 9/9bis/9ter, et le BRIEF du module KARMA à ~/purama/karma/BRIEF.md. Respect §20 VITAE pour pricing/split/Graines. Respect §21 DESIGN SYSTEM pour tous composants visuels. Montre-moi ton plan d'exécution. NE CODE PAS ENCORE. »
